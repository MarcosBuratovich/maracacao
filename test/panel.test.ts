...
const PENDIENTES = new Set<string>([
  ...
  'sitio:minis.nota',
  'sitio:gotas.titulo',
  'sitio:gotas.desdeEtiqueta',
  'sitio:gotas.cuerpo',
  'sitio:gotas.sabores',
  'sitio:gotas.notaPrecio',
  'sitio:polvoCard.titulo',
  'sitio:polvoCard.chip',
  'sitio:polvoCard.cuerpo',
  'sitio:polvo.kicker',
  'sitio:polvo.chip',
  'sitio:polvo.titulo',
  'sitio:polvo.cuerpo',
  'sitio:polvo.altPrefijo',
  'sitio:catar.kicker',
  'sitio:catar.titulo',
  'sitio:catar.pasos[].nombre',
  'sitio:catar.pasos[].texto',
  'sitio:catar.cita',
  'sitio:catar.porqueTitulo',
  'sitio:catar.porque',
  'sitio:catar.aporteTitulo',
  'sitio:catar.aporte',
  'sitio:recetas.kicker',
  'sitio:recetas.titulo',
  'sitio:recetas.deslizaNota',
  'sitio:recetas.verCompleta',
  'sitio:recetas.etiquetaTip',
  'sitio:recetas.listaAria',
  'sitio:recetas.lista[].kicker',
  'sitio:recetas.lista[].titulo',
  'sitio:recetas.lista[].resumen',
  'sitio:recetas.lista[].ingredientes[]',
  'sitio:recetas.lista[].pasos',
  'sitio:recetas.lista[].tip',
  'sitio:recetas.lista[].chipPolvo',
  'sitio:nosotros.kicker',
  'sitio:nosotros.titulo',
  'sitio:nosotros.parrafos[]',
  'sitio:nosotros.cacaoTitulo',
  'sitio:nosotros.cacao',
  'sitio:nosotros.datos.0',
  'sitio:nosotros.datos.1',
  'sitio:nosotros.personajeAlt',
  'sitio:negocios.kicker',
  'sitio:negocios.titulo',
  'sitio:negocios.intro',
  'sitio:negocios.correoEtiqueta',
  'sitio:negocios.correo',
  'sitio:negocios.fichasCta',
  'sitio:negocios.fichaEnlace',
  'sitio:negocios.fichas[].dato',
  'sitio:negocios.fichas[].estado',
  'sitio:negocios.tabs.0.etiqueta',
  'sitio:negocios.tabs.0.titulo',
  'sitio:negocios.tabs.0.precioNota',
  'sitio:negocios.tabs.0.precio',
  'sitio:negocios.tabs.0.cuerpo',
  'sitio:negocios.tabs.0.datos[]',
  'sitio:negocios.tabs.1.etiqueta',
  'sitio:negocios.tabs.1.titulo',
  'sitio:negocios.tabs.1.precioNota',
  'sitio:negocios.tabs.1.cuerpo',
  'sitio:negocios.tabs.1.datos[]',
  'sitio:negocios.tabs.2.etiqueta',
  'sitio:negocios.tabs.2.titulo',
  'sitio:negocios.tabs.2.precioNota',
  'sitio:negocios.tabs.2.cuerpo',
  'sitio:negocios.tabs.2.datos[]',
  ...
  'sabores:gotas[].nombre',
  'sabores:gotas[].precio',
  'sabores:polvo[].nombre',
