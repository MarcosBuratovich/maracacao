 ...
 *
 * Está partido en seis archivos por tema —cabecera, producto, experiencia,
 * negocio, contacto y páginas— y este los junta. Los seis exportan CLAVES y
 * no grupos: si cada uno devolviera un `grupo`, el documento tendría seis
 * niveles de anidamiento que no existen en el contenido y todas las rutas
 * del sistema cambiarían.
 *
